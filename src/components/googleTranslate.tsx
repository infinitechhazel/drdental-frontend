...
interface TranslateElementConstructor {
  new (options: TranslateOptions, elementId: string): object
  InlineLayout: {
    SIMPLE: unknown
  }
}
...
const GoogleTranslate = () => {
  ...
  useEffect(() => {
    ...
    ;(window as Window & GoogleTranslateWindow).googleTranslateElementInit = () => {
      const win = window as Window & GoogleTranslateWindow
